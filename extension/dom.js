...
const els = {
  ...
  settingQueueConcurrency: $("setting-queue-concurrency"),
  settingsBtnReset: $("settings-btn-reset"),
  settingTags: $("setting-tags"),
  settingAnalyzeLink: $("setting-analyze-link"),
  settingAnalyzeSample: $("setting-analyze-sample"),
  settingAnalyzeFile: $("setting-analyze-file"),
  settingBpmStyle: $("setting-bpm-style"),
  settingKeyStyle: $("setting-key-style"),
